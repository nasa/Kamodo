...
def test_times():
    ...
    '''
    dt1 = datetime.datetime(2015, 6, 22, 0, 2, 30, tzinfo=datetime.timezone.utc)
    dt2 = datetime.datetime(2015, 6, 23, 23, 57, 30, tzinfo=datetime.timezone.utc)
    ft = MW.File_Times(model, file_dir)
...
def test_coord_range():
    ...
    assert cr['Q_Joule']['time'][1] == pytest.approx(47.958333333333336, abs=.000001)
...
def test_plot_value():
    ...
    assert fig.data[0]['x'][2] == pytest.approx(0.2083333432674408, abs=.000001) and \
