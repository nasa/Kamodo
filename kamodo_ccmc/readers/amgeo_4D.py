...
model_varnames = {'E_ph':['E_east','Electric Field (eastward)',0,'MAG','sph',['time','lon','lat'],'V/m'], 
                  ...
                  'int_joule_heat_n':['W_JouleN','Northern Hemisphere Integrated Joule Heating',5,'MAG','sph',['time'],'GW'],   
                  'int_joule_heat_s':['W_JouleS','Southern Hemisphere Integrated Joule Heating',6,'MAG','sph',['time'],'GW'],   
...
def MODEL():
    ...
    class MODEL(Kamodo):
        ...
        def __init__(self, file_pattern, variables_requested = [], 
            ...
            time_list = [key[:-1] for key in f_data1.keys() if key not in ['lats','lons']]  # remove 'N' or 'S' at end of time
            ...
            if fulltime:  # add boundary time (default value)
                ...
                if current_idx+1 == len(files):
                    ...
                    min_file = file_dir+'*'+filenames[current_idx+1][0][-12:-4]  #+1 for adding an end time
            ...
            lon = unique(f_data1['lons'])  # NEED lon here for longitude swapping logic
        ...
        def wrap3Dlat(self, varname, variable, hemi):  # HOW TO HANDLE 1 hemisphere AUTO
