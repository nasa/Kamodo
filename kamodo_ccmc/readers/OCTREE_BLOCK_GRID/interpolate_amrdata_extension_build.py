...
""",
#    sources=[],
    sources=['interpolate_amrdata.c','setup_parent.c','setup_octree.c','interpolate_in_block.c','find_octree_block.c','find_in_block.c','find_block.c','trace_fieldline.c'],   # includes additional sources
