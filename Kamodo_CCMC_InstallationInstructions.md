...
1. Move to the directory where you want the Kamodo package to be stored.
1*. If you wish to create a new environment, use this command; otherwise, skip this step:
